...
ADFGX.prototype.doConsole = function()
{
  ...
  if (this.key.length != 25)
  {
    if (this.mode == 'e')
    {
      ...
      console.log("Key not properly set, creating one for you... ");
    }
    else
    {
      console.log("Key not set, cannot decrypt.");
      process.exit();
    }
  }
  else
  ...
  if (this.mode == 'e')
  {
    console.log('Mode: ' + "Encrypt");
    console.log("pt: " + (this.text));
    console.log("CT: " + (this.encrypt()));
  }
  else if (this.mode == 'd')
  {
    console.log('Mode: ' + "Decrypt");
    console.log("CT: " + (this.text));
    console.log("pt: " + (this.decrypt()));
  }
